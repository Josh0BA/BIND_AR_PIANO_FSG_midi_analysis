...
for _, row in df.iterrows():
    ...
    for t in row['transitions']:
        transition_rows.append({
            ...
            'transition_time': t['onset_to_onset'],
...
# Zusätzlicher Export: nur die 5 gewünschten Parameter
df_transitions_compact = df_transitions.reindex(
    columns=['Participant_ID', 'Test', 'transition_code', 'frequency', 'transition_time']
)
df_transitions_compact.to_csv(
    'transition_times_results_compact.csv',
    index=False,
    encoding='utf-8-sig'
)
